...
<form name="reportForm" method="POST" action="job_profitability_report.html">
...
<c:choose>
	...
	<c:otherwise>
		<charm:queryService var="result"
			namedQueryId="reports.job_cost.single_org">
		...
		<display:table name="${result}" export="true" id="row"  class="bodytable" pagesize="100" requestURI="job_profitability_report.html" varTotals="totals">
			...
			<display:footer media="html">
				<tr style="font-weight:bold;">
					...
					<td></td>
					<td></td>   		
					<td style="text-align:right;"><fmt:formatNumber type="currency" value="${totals.column5} "/></td>   			
					<td style="text-align:right;"><fmt:formatNumber type="currency" value="${totals.column6} "/></td>   		
					...
					<td style="text-align:right;"><fmt:formatNumber type="currency" value="${(totals.column5 - totals.column6)}"/></td>   		
					<%-- gross profit pct = invoiced - cost / invoiced--%>
					<td style="text-align:right;"><fmt:formatNumber pattern="##0.00%" value="${(totals.column5 - totals.column6) / totals.column5}"/></td>   		
					<%-- cost pct = cost / invoiced --%>
					<td style="text-align:right;"><fmt:formatNumber pattern="##0.00%" value="${totals.column6 / totals.column5}"/></td>   		
					<td></td>
					<td></td>
					<td></td>
				</tr>
