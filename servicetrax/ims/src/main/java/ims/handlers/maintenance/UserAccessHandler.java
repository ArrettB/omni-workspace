...
public class UserAccessHandler extends BaseHandler {
    ...
    private static final String MESSAGE = "Please enter your User Name and Password..."
    ...
    public boolean handleEnvironment(InvocationContext ic) {
        ...
        try {
            ...
            if (action.equalsIgnoreCase("displayLogin")) {
                ic.setTransientDatum("message", MESSAGE);
                //false will automatically displays login page
                bRet = false;
