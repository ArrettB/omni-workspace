...
public class StringUtil
{
	...
	{
		return IMSUtil.PSTMT_TAG_START + IMSUtil.PSTMT_TYPE_FORCE_STRING + s + IMSUtil.PSTMT_TAG_END;
	}

	public static String toPStmtString(String s)
	{
		return IMSUtil.PSTMT_TAG_START + IMSUtil.PSTMT_TYPE_STRING + s + IMSUtil.PSTMT_TAG_END;
	}
	
	public static String toPStmtInt(String s)
	{
		return IMSUtil.PSTMT_TAG_START + IMSUtil.PSTMT_TYPE_INT + s + IMSUtil.PSTMT_TAG_END;
	}
	
	public static String toPStmtInt(int i)
	{
		return IMSUtil.PSTMT_TAG_START + IMSUtil.PSTMT_TYPE_INT + i + IMSUtil.PSTMT_TAG_END;
	}
