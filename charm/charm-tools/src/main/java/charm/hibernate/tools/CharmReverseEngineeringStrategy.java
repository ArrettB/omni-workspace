...
import com.apexit.tools.hibernate.strategy.ApexReverseEngineeringStrategy;

/**
 * @version $Id: CharmReverseEngineeringStrategy.java 332 2008-07-25 18:46:53Z john.cicchese $
 */
public class CharmReverseEngineeringStrategy extends ApexReverseEngineeringStrategy
{
	private final static Logger logger = Logger.getLogger(CharmReverseEngineeringStrategy.class);

	public CharmReverseEngineeringStrategy(ReverseEngineeringStrategy delegate)
	{
		super(delegate);
...
//		System.out.println("tableToClassName");
	...
	public String foreignKeyToEntityName(String keyname, TableIdentifier fromTable, List fromColumnNames, TableIdentifier referencedTable, List referencedColumnNames, boolean uniqueReference)
	{
		...
		String propertyName = Introspector.decapitalize(singular);
